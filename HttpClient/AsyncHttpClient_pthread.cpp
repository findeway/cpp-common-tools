#include "AsyncHttpClient_pthread.h"
#include "Util.h"
...
void CAsyncHttpClient::Request(const wchar_t* szUrl, EHttp_Request requestMethod, OnResponseCallback callback, void* userdata)
{
	...
	int status = pthread_create(&m_hRequestThread,&attr,&CAsyncHttpClient::StartRequest,(void*)this);
}
...
void* CAsyncHttpClient::StartRequest(void* param)
{
